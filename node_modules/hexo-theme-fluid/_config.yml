...
web_analytics:  # 网页访问统计
  ...
  leancloud:
    app_id: ZRKe1lomdan44B3OvvshwuZJ-MdYXbMMI
    app_key: CPdvg4ZZ1oWnbZWc6UhYrTsz
...
gitalk:
  clientID: 66899eab769da39fa6ff
  clientSecret: 8c55813b64c436483458199126f546a4e6114788
  repo: CommentStorage
  owner: WizardWoz
  admin: ['WizardWoz']
  language: zh-CN
...
about:
  ...
  icons:
    - { class: "iconfont icon-github-fill", link: "https://github.com/WizardWoz", tip: "GitHub" }
    - { class: "iconfont icon-bilibili", link: "https://space.bilibili.com/337144701", tip: "B站" }
    - { class: "iconfont icon-wechat-fill", qrcode: "/img/QRcode.png" }
